...
__game_regex = re.compile(
    r"(CoC|3\.5|[3-5]e|PF[1-2]e|BitD|BRP|CofD|Cyberpunk|DLC|DLR|DCC|DW|ODND|ADND|BX|DND2e|1DND|Earthdawn|Fate|Feast|FWS|GURPS|L5R|MCC|MotW|MM3|Numenera|SWADE|SWD|SR[3-6]|Starfinder|SWRPG|SWN|40K|WoD|(?:(?:\[|<|\(|{)(?:Flexible|Other)(?:\]|>|\)|})))",
    flags=re.IGNORECASE,
)
