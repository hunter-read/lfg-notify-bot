...
def test_bug_feature_message(subject, body):
    message = Message(None, {"id": "12345", "author": testUser, "subject": subject, "body": body})
    assert parse_incoming_message(db, message) == "For error reporting or feature requests, please message my [human](https://www.reddit.com/user/Perfekthuntr)."
...
def test_unknown_message():
    ...
    assert parse_incoming_message(db, message) == ("Unknown message sent. If you wish to subscribe to this bot, please send a new message titled 'Subscribe' with your [options](https://github.com/hunter-read/lfg-notify-bot/blob/main/README.md) in the body of the message.  \n"
