...
message_flags_data = [
    ...
    ("abovevtt", Location.ONLINE.value, Nsfw.EXCLUDE.value, PlayByPost.INCLUDE.value, OneShot.INCLUDE.value, Identity.NONE.flag, AgeLimit.NONE.value, Vtt.ABOVE_VTT.flag, False, False),
